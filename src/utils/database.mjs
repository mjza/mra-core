...
import { closeSequelize, MraAuditLogsCore, MraCustomers, MragCities, MragCountries, MraGenderTypes, MraTicketCategories, MraTickets, MraUserDetails, MraUsers, Sequelize, sequelize } from '../models/index.mjs';
const { Op } = Sequelize;
